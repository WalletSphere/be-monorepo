...
import com.walletsphere.pricingservice.model.AUTHENTICATE_TOKEN_URL
import com.walletsphere.pricingservice.model.auth.AuthenticationResp
import com.walletsphere.pricingservice.model.auth.AuthenticationResult
import com.walletsphere.pricingservice.model.auth.JwtTokenValidationResult
...
@Service
class AuthenticationMessageHandler(private val restTemplate: RestTemplate,
